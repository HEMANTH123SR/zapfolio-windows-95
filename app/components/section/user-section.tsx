...
export const UserComponent = ({
  ...
  user: UserDetailedObjectType;
  componentsToShow: ComponentsToShowType;
}) => {
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col space-y-3 px-8 py-6 h-[93%] mt-1  overflow-y-scroll">
              ...
              {user.position && componentsToShow.position ? (
                <div className="flex flex-col space-y-3">
              ...
              {user.projects && componentsToShow.projects ? (
                <div className="flex flex-col space-y-3">
                  <h2 className="font-semibold text-xl underline mb-3 mt-8">
                    Projects
                  </h2>
              ...
              {user.educations && componentsToShow.educations ? (
                <div className="flex flex-col space-y-3">
                  <h2 className="font-semibold text-xl underline mb-3 mt-8">
                    Education
                  </h2>
              ...
              {user.certifications && componentsToShow.certifications ? (
                <div className="flex flex-col space-y-3">
                  <h2 className="font-semibold text-xl underline mb-3 mt-8">
                    Certs
                  </h2>
              ...
              {user.skills && componentsToShow.skills ? (
                <div className="flex flex-col space-y-3">
                  <h2 className="font-semibold text-xl underline mb-3 mt-8">
                    Certs
                  </h2>
              ...
              {user.languages && componentsToShow.languages ? (
                <div className="flex flex-col space-y-3">
                  <h2 className="font-semibold text-xl underline mb-3 mt-8">
                    Languages
                  </h2>
